          ...
          <div>
            {data?.getCallfiles?.result?.map((res, index) => {
              ...
              return (
                <div
                  key={index}
                  className="text-[0.7rem] items-center py-2 px-3 bg-gray-100 even:bg-gray-200 2xl:text-xs gap-2 text-gray-600 grid grid-cols-[repeat(15,_minmax(0,_1fr))] w-full "
                >
