...
const DispositionConfigurationView = () => {
  ...
  return (
    <>
      <div
        className="h-full w-full flex flex-col overflow-hidden p-2"
        onMouseDown={(e) => {
      ...
      >
        <h1 className="text-2xl font-black uppercase px-3 py-5 ">
        ...
        <div className="w-full h-full flex overflow-hidden">
            ...
            >
              ...
              <label className="flex flex-col">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setInputValue((prev) => ({ ...prev, code: e.target.value }))
                  }
                  className={`${
                ...
                >
                  {selectedBuckets.length < 1 ? (
                    ...
                    <p className="truncate capitalize">
                      {selectedBuckets.map((e) => bucketObject[e]).join(", ")}
                    </p>
                  )}
          ...
          <div className="w-6/4 overflow-hidden flex items-end justify-end px-10 flex-col">
            <div className="border flex shadow-md items-center px-3 rounded-md" >
              <svg
            ...
            <div className="w-full h-full overflow-y-auto rounded-md p-2 cursor-default select-none">
              {dispoData.map((dispo) => {
                ...
                return (
                  <div
                    key={dispo.id}
                    className="grid grid-cols-8 text-sm py-1 hover:bg-blue-50 even:bg-slate-50 text-gray-600 items-center"
                  >
