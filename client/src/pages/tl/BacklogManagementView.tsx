  ...
  return (
    <div className="grid grid-cols-3 grid-rows-1 h-full items-center overflow-hidden" onMouseDown={(e)=> {
      ...
      <div className="h-full p-10 flex flex-col justify-center">
        <motion.div className="bg-gray-200 rounded-md border-gray-400 shadow-md border-2 p-5"
        initial={{opacity: 0,  y: 20}}
        animate={{opacity: 1, y: 0}}
        
        >
        <h1 className="text-2xl text-slate-700 text-center font-black uppercase py-2">Select Report</h1>
        <div className="p-5 flex flex-col gap-2 justify-center">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap max-h-50 gap-x-5 gap-y-2 border-slate-400 rounded-lg p-2 justify-center border overflow-y-auto">
              {
                disposition?.getDispositionTypes?.map((dispoTypes) => 
                  <label key={dispoTypes.id} className="w-2/10 2xl:text-xs lg:text-[8px] items-center flex gap-2">
                    <input type="checkbox" 
          ...
          <div className="flex gap-5 mt-2 justify-end">
            <button type="button" className='bg-blue-500 border-2 border-blue-800 transition-all font-black uppercase hover:bg-blue-600 focus:outline-none text-white  focus:ring-4 focus:ring-blue-300 rounded-lg text-sm px-5 py-2.5 cursor-pointer flex gap-2 items-center justify-center'>
              <span>Export</span>
              <FaDownload/>
            </button>
          </div>
