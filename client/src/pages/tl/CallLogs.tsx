...
const CallLogs = () => {
  ...
  return (
    <div className="w-full relative px-5 gap-2 pt-2 pb-5 h-[91vh] flex flex-col">
      <motion.div
        ...
        <motion.div className="flex flex-col h-full overflow-auto">
          ...
          <div className="w-full flex flex-col h-full overflow-auto">
            {filteredRows.length === 0 ? (
              <div className="flex border-black justify-center items-center bg-gray-200 py-3 rounded-b-md shadow-md italic text-gray-400 border-x border-b">
                No agent found
              </div>
            ) : (
