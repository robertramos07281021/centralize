...
const CallfilesViews: React.FC<Props> = ({
  ...
  const { data: deptBucket, refetch: bucketRefetch } = useQuery<{
    gediveptBucket: Bucket[];
  }>(TL_BUCKET, { skip: !Boolean(bucket) });
  ...
  return (
    <>
      <div className=" h-full w-full overflow-y-auto overflow-hidden px-5 flex-nowrap overflow-x-auto inline flex-col relative">
        <div className="w-full table-fixed text-left">
          <div className="w-full">
            <div className=" w-full px-2 py-2 uppercase rounded-t-md truncate bg-gray-300 grid grid-cols-[repeat(15,_minmax(0,_1fr))] gap-2 font-black text-black text-xs">
              {labels.map((x, index) => (
                <div
          ...
          <div>
            {data?.getCallfiles?.result?.map((res, index) => {
              ...
              const findBucket = deptBucket?.gediveptBucket.find(
                (e) => e._id === res.callfile.bucket
              );
              ...
              return (
                <div
                  key={index}
                  className="text-[0.7rem] py-2 px-3 bg-gray-100 even:bg-gray-200 2xl:text-xs gap-2 text-gray-600 grid grid-cols-[repeat(15,_minmax(0,_1fr))] w-full "
                >
                  ...
                  <div className="grid grid-rows-2 grid-cols-2 gap-2 justify-center items-center  ">
                    {checkStatus && (
                      <>
                        <div
                          className="rounded-sm flex justify-center hover:bg-purple-800 transition-all px-1 py-1 cursor-pointer bg-purple-700 text-white border border-purple-800"
                          onClick={() => {
                        ...
                        <div
                          className="rounded-sm flex justify-center hover:bg-green-800 px-1 py-1 cursor-pointer bg-green-700 text-white border border-green-800"
                          onClick={() =>
                            onClickIcon(
                              res.callfile._id,
                              "FINISHED",
                        ...
                        <IoSettingsSharp
                          className="text-orange-500 lg:text-xs 2xl:text-lg cursor-pointer hover:scale-110"
                          title="Set Target"
                          onClick={() => {
                            setModalTarget(true);
                    ...
                    <FaDownload
                      className="text-blue-500 lg:text-xs 2xl:text-lg cursor-pointer hover:scale-110"
                      onClick={() =>
                        onClickIcon(
                          res.callfile._id,
                          "DOWNLOAD",
          ...
          <div className="w-2/8 border h-2/5 rounded-md flex flex-col overflow-hidden border-slate-500">
            ...
            <div className="w-full h-full bg-white flex items-center justify-center flex-col gap-8">
              <label className="flex gap-2 flex-col">
                <p className="2xl:text-2xl lg:text-lg">
        ...
        <div className="absolute top-0 left-0 bg-black/20 backdrop-blur-xs w-full h-full z-40 flex items-center justify-center">
          <div className="w-2/8 border h-2/5 rounded-md flex flex-col overflow-hidden border-slate-500">
            ...
            <div className="w-full h-full bg-white flex items-center justify-center flex-col gap-8">
              ...
              <div className="flex gap-5">
                <button
                  className="w-30 bg-blue-500 py-2 rounded text-white hover:bg-blue-700 cursor-pointer"
