...
const PTP = () => {
  ...
  return (
    <div className="border-orange-800 border-2 bg-white text-orange-500 shadow-md rounded-sm flex flex-col">
      <div className="lg:text-xs rounded-t-xs flex items-center text-orange-800 justify-center bg-orange-400 border-b-2 border-orange-800 2xl:text-lg font-black h-[50%] ">
        <h1>
          PTP{" "}
          <span className="text-[0.6rem] 2xl:text-xs font-black  capitalize">{`(${intervalTypes})`}</span>{" "}
        </h1>
      </div>
      <div className="w-full flex justify-between bg-orange-100 h-[50%] items-center relative  text-lg  2xl:text-xl">
        {!loading ? (
          <>
            <div className="font-bold text-center absolute -top-4 bg-orange-100 px-2.5 shadow-md text-orange-800 rounded-full border-2 border-orange-800 right-2">
